...
- (void)configBlankPagehasData:(BOOL)hasData hasError:(BOOL)hasError reloadButtonBlock:(void (^)(id))block{
    if (hasData) {
        ...
        [self.blankPageView configWithhasData:hasData hasError:hasError reloadButtonBlock:block];
    }
}
