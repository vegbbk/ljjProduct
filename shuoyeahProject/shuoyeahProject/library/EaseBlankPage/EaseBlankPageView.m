...
- (void)configWithhasData:(BOOL)hasData hasError:(BOOL)hasError reloadButtonBlock:(void (^)(id))block{
    ...
    [_monkeyView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.equalTo(self).with.offset(-64);
